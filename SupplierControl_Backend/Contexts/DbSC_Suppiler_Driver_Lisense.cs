...
public partial class DbSC_Suppiler_Driver_Lisense : DbContext
{
    public DbSC_Suppiler_Driver_Lisense()
    {
    }

    public DbSC_Suppiler_Driver_Lisense(DbContextOptions<DbSC_Suppiler_Driver_Lisense> options)
        : base(options)
    {
    }
